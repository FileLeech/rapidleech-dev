...
});oSettings.nPaginateList=nList},fnUpdate:function(oSettings,fnCallbackDraw){var iPageCount=$.fn.dataTableExt.oPagination.iFullNumbersShowPages;
...
for(i=0;i<iColumns;i++){$(oSettings.aoColumns[i].nTh).removeClass("sorting_asc sorting_desc sorting")
